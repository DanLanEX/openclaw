...
fun ChatTypingIndicatorBubble() {
  ChatBubbleContainer(
    ...
    Row(
      ...
      Text(stringResource(R.string.chat_typing_indicator), style = mobileCallout, color = mobileTextSecondary)
    }
  }
}
...
fun ChatStreamingAssistantBubble(text: String) {
  ChatBubbleContainer(
    ...
    roleLabel = stringResource(R.string.chat_streaming_label),
  ) {
